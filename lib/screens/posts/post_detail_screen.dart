...
class _CommentTileState extends State<_CommentTile> {
  ...
  Future<void> _deleteComment() async {
    ...
    await context.read<CommentProvider>().deleteComment(widget.comment.id, widget.postId);
  }
          ...
          if (_isEditing)
            ...
            Row(
              ...
              children: [
                ...
                Expanded(child: Text(comment.content, style: theme.textTheme.bodyMedium)),
                if (widget.isOwner) ...[
                  InkWell(
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(6),
                      child: Icon(Icons.delete, size: 18, color: theme.colorScheme.error),
                    ),
                  ),
                ],
              ],
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => _openFullImage(comment.imageUrls[index]),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image.network(
                        ...
                        fit: BoxFit.cover,
                        errorBuilder: (context, error, stackTrace) =>
                            Icon(Icons.broken_image, size: 24, color: theme.colorScheme.outline),
                      ),
                    ),
                  ),
                ),
